...
BEGIN_MESSAGE_MAP(CAgoraMediaSourceApp, CWinApp)
...
BOOL CAgoraMediaSourceApp::InitInstance()
{
	...
	CString str("ChineseSimplified");
	CLanguageSet::GetInstance()->SetCurrentLanguage(str);
	CString dll("ChineseSimplified.dll");
	CLanguageSet::GetInstance()->LoadLanguageModule(dll);
